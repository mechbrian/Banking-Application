...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        b.Withdraw(300, p6);
        b.Withdraw((decimal)32.90, p6);
        b.Withdraw(50, p7);
        b.Withdraw((decimal)111.11, p8);
        Console.WriteLine(b);
        b = Bank.GetAccount("SV-100003") as SavingAccount;
        b.Deposit(300, p3); //ok even though p3 is not a holder
        b.Deposit((decimal)32.90, p2);
        b.Deposit(50, p5);
        b.Withdraw((decimal)111.11, p10);
        Console.WriteLine(b);
        //a checking account
        CheckingAccount c = Bank.GetAccount("CK-100004") as CheckingAccount;
        c.Deposit((decimal)33.33, p7);
        c.Deposit((decimal)40.44, p7);
        c.Withdraw(150, p2);
        c.Withdraw(200, p4);
        c.Withdraw(645, p6);
        c.Withdraw(350, p6);
        ...
        {
            p3.Logout();
            a.DoPurchase((decimal)12.5, p3); //exception user is not logged in
        }
        catch (AccountException e) { Console.WriteLine(e.Message); }
        try
        {
            a.DoPurchase((decimal)12.5, p0); //user is not associated with this account
        }
        catch (AccountException e) { Console.WriteLine(e.Message); }
        try
        {
        ...
        Logger.SaveLoginEvents("LoginEvents.txt");
        Logger.SaveTransactionEvents("TransactionEvents.txt");
    }
